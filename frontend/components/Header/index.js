...
const Header = ({ isErrorPage }) => {
  ...
  return(
    <header className={`site-header ${!onTop ? 'site-header--fixed' : ''}`}>
      <div className="container">
        ...
        <nav ref={navRef} className={`site-nav ${menuOpen ? 'site-nav--open' : ''}`}>
          ...
          {user && user.email == 'sasa.kov.g@gmail.com' && window.location.pathname == '/admin' ?
          <>
    ...
    <Dropdown.Menu>
        ...
        {user.email == 'sasa.kov.g@gmail.com' &&
            <MenuItem onSelect={() => {
                router.push('/admin');
            }}>
                Admin panel
        ...
        <MenuItem onSelect={() => {
          ...
          /*(
                    ...
                    <Link href="/login">
                        <button className="site-header__btn-avatar" size="25px">Login</button>
                    </Link>
                )}
          {/*<Link href="/login">
